...
def neanderthal_admixture_model(num_eu=170,num_as=394,num_nean = 1,anc_time=900,mix_time1=2000,mix_time2=1000,mix_time3=1000,mix_time4=1000,split_time_1=120000,split_time_2=2300,split_time_3=1500,f1=0.022,f2=0.00,f3=0.00,f4=0.20,Ne0=10000,Ne1=2500,Ne2=10000,mu=1.5e-8,window_size = 100000,num_SNP = 1,num_rep=1,coverage=False,sim_num=1, model_num=1):
    ...
    for chr in range(1, 23):
        ...
        EU += freq_EU
        AS += freq_AS
    return np.array(EU), np.array(AS)
...
def symmetry_stat(sim_num, model_num, EU, AS):
    ...
    np.savetxt('data/job%s/mat/EU_AS_%s_%s_%s' %(os.environ["SLURM_JOB_ID"],model_num,sim_num,os.environ["SLURM_NODEID"]), EU_AS, delimiter=" ", fmt='%f') # temporary
...
def outmatrix(sim_num, model_num, Symm_stat):
    np.savetxt('data/job%s/mat/symmetry_matrix_%s_%s_%s' %(os.environ["SLURM_JOB_ID"],model_num,sim_num,os.environ["SLURM_NODEID"]), Symm_stat, delimiter=" ", fmt='%f') # temporary TODO: compress Symm_stat matrix
    return
...
def simulateFromDist(sim_num, model_num):
    ...
    if model_num == 1:
        ...
        args.f1 = f1
        print("model 1: ")
        print("t1:{} t3:{} m1:{} m2:{} m3:{} m4:{} a:{} d:{} f1:{} f2:{} f3:{} f4:{}\n".format(t1, t3, m1, m2, m3, m4, a, d, f1, args.f2, args.f3, args.f4))
        # f all 0
        model_data = neanderthal_admixture_model(mix_time1=m1, 
			      					mix_time2=m2,
									mix_time3=m3,
									mix_time4=m4,
									split_time_1=t1,
    ...
    Symm_stat = symmetry_stat(sim_num, model_num, model_data[0], model_data[1])
    outmatrix(sim_num, model_num, Symm_stat)
    return    
